...
public class RsaUtils {
    ...
    public static String buildRsaEncryptByPublicKey(String data, String key) {
        try {
            ...
            return Base64.getEncoder()
                .encodeToString(rsaSplitCodec(cipher, ENCRYPT_MODE, data.getBytes(Charset.defaultCharset())));
        }
        catch (Exception e) {
    ...
    public static String buildRsaDecryptByPublicKey(String data, String key) {
        try {
            ...
            return new String(rsaSplitCodec(cipher, DECRYPT_MODE, Base64.getDecoder().decode(data)),
