...
INSERT INTO `config_info` VALUES (3, 'oner365-gateway-dev.yml', 'DEFAULT_GROUP', 'spring:\n  cloud:\n    gateway:\n      discovery:\n        locator:\n          enabled: true\n          lower-case-service-id: true\n          \n  datasource:\n    #mysql\n    driver-class-name: com.mysql.cj.jdbc.Driver\n    url: jdbc:mysql://localhost:3306/oner365?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=GMT%2B8\n    username: root\n    password: 1234\n    \n  jpa: \n    hibernate:\n      ddl-auto: update\n    show-sql: false\n    database-platform: org.hibernate.dialect.MySQL5InnoDBDialect\n    open-in-view: true\n      \n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8 \n\n# 白名单\nignore:\n  whites:\n    - /api\n    - /system/auth\n    - /system/file/download\n    - /swagger\n    - /webjars\n    - /instances\n    - /v3\n    - /csrf\n    - /doc.html\n\n\nlogging:\n  config: classpath:logback-spring.xml\n      \n', '362c0e02096663e6621c082403968d3c', '2021-07-04 10:54:06', '2022-02-08 15:48:07', 'nacos', '0:0:0:0:0:0:0:1', 'oner365-cloud', 'dev', '', '', '', 'yaml', '');
INSERT INTO `config_info` VALUES (4, 'oner365-monitor-dev.yml', 'DEFAULT_GROUP', 'spring:\n  # datasource\n  datasource:\n    druid:\n      db-type: com.alibaba.druid.pool.DruidDataSource\n      driver-class-name: com.mysql.cj.jdbc.Driver\n      url: jdbc:mysql://localhost:3306/oner365?useUnicode=true&characterEncoding=utf8&autoReconnect=true&useSSL=false&allowPublicKeyRetrieval=true&serverTimezone=GMT%2B8\n      username: root\n      password: 1234\n      \n      test-while-idle: true\n      initial-size: 1\n      max-active: 10\n      min-idle: 1\n      # druid 监控\n      filters: stat, slf4j\n      stat-view-servlet:\n        enabled: true\n        allow: 127.0.0.1\n        login-username: root\n        login-password: 1234\n        reset-enable: false \n      web-stat-filter:\n        enabled: true\n        exclusions: \"*.js,*.gif,*.jpg,*.png,*.css,*.ico,/druid/*\"\n    \n  redis:\n    database: 1\n  \n  data:\n    redis:\n      repositories:\n        enabled: false\n\n  # sentinel监控\n  cloud:\n    sentinel:\n      eager: true\n      transport:\n        dashboard: 127.0.0.1:8850\n      datasource:\n        ds1:\n          nacos:\n            server-addr: ${spring.cloud.nacos.server-addr}\n            dataId: sentinel-oner365-gateway.json\n            groupId: DEFAULT_GROUP\n            data-type: json\n            rule-type: flow\n\nmybatis:\n  mapper-locations: classpath:mapper/*.xml\n  type-aliases-package: com.cy.monitor.entity\n\n#fdfs\nfdfs:\n  ip: 127.0.0.1\n  port: 22\n  user: root\n  password: root\n  storage:\n    path: /data/fastdfs-storage/data/M00/00\n  webServerUrl:          \n  \n#服务器配置  \nservers:\n  deploy: true\n  path: /User/taoliu/gitee\n  version: 1.0.0-SNAPSHOT\n  suffix: jar\n  #部署多台服务器 必须包含ip 端口 账号 密码 逗号分隔\n  ip: 192.168.101.130\n  port: 22\n  username: root\n  password: root\n\nlogging:\n  config: classpath:logback-spring.xml\n  ', '08fb3b39849621125ba6de37d72a9e6c', '2021-07-04 12:15:05', '2022-04-19 08:17:03', 'nacos', '0:0:0:0:0:0:0:1', 'oner365-cloud', 'dev', '', '', '', 'yaml', '');
