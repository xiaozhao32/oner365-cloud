...
CREATE TABLE `his_config_info` (
  ...
  KEY `idx_did` (`data_id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='多租户改造';
...
-- ----------------------------
BEGIN;
INSERT INTO `tenant_info` VALUES (2, '1', 'dev', 'dev', '开发环境', 'oner365-nacos', 1625707491397, 1625708174502);
COMMIT;
