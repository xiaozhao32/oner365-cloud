...
INSERT INTO `config_info` VALUES (31, 'oner365-clickhouse-dev.yml', 'DEFAULT_GROUP', 'spring:\n  jpa:\n    database-platform: org.hibernate.dialect.MySQL55Dialect  \n\n  datasource:\n    druid:\n      db-type: com.alibaba.druid.pool.DruidDataSource\n      driver-class-name: com.clickhouse.jdbc.ClickHouseDriver\n      url: jdbc:clickhouse://localhost:8123/default\n      username: default\n      password: 1234\n      \n      test-while-idle: false\n      initial-size: 1\n      max-active: 10\n      min-idle: 1\n    \n  sql:\n    init:\n      mode: never\n      schema-locations:\n      - classpath:db/schema.sql\n\n  jackson:\n    date-format: yyyy-MM-dd HH:mm:ss\n    time-zone: GMT+8\n\nlogging:\n  config: classpath:logback-spring.xml\n  \n  level:\n    com:\n      clickhouse: error', '3920ca4b9fde7a078551d6e3d6a3d19b', '2024-12-30 17:00:17', '2024-12-30 17:59:01', NULL, '0:0:0:0:0:0:0:1', 'oner365-cloud', 'dev', '', '', '', 'yaml', '', '');
...
INSERT INTO `config_info` VALUES (33, 'oner365-keycloak-dev.yml', 'DEFAULT_GROUP', 'logging:\n  config: classpath:logback-spring.xml\n  ', 'bd0d8038d6bd9e0a7f2cae83117e4fe5', '2025-04-28 17:01:01', '2025-04-28 17:01:24', 'nacos', '0:0:0:0:0:0:0:1', 'oner365-cloud', 'dev', '', '', '', 'yaml', '', '');
