...
public interface IGatewayRouteClient {
    ...
    ResponseData<GatewayRouteDto> get(@PathVariable("id") String id);
    ...
    ResponseData<Boolean> updateRouteStatus(@PathVariable("id") String id, @PathVariable("status") StatusEnum status);
